...
#define PS2E_DEV9_VERSION 0x0001
...
void CALLBACK DEV9irqCallback(void (*callback)());
...
typedef void (CALLBACK* _DEV9irqCallback)(void (*callback)());
