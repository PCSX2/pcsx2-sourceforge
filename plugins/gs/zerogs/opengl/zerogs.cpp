...
#define ZEROGS_SAVEVER 0xaa000004
...
char* EFFECT_DIR = "C:\\programming\\ps2dev\\pcsx2\\zerogs\\opengl\\";
char* EFFECT_NAME = "C:\\programming\\ps2dev\\pcsx2\\zerogs\\opengl\\ps2hw.fx";
#else
...
bool ZeroGS::Load(char* pbydata)
{
	...
	if( strncmp(pbydata, libraryName, 6) == 0 && *(u32*)(pbydata+16) == ZEROGS_SAVEVER ) {
