...
#define CYCLES_PER_MS (36864000/1500)
...
ENDX:
    ...
    if( (spu2Ru16(REG_C1_MMIX) & 0xC0) && (spu2Ru16(REG_C1_ADMAS) & 0x1) && !(spu2Ru16(REG_C1_CTRL) & 0x30)) {
        for(int ns=0;ns<NSSIZE;ns++) { 
		    Adma7.Index +=1;
...
int ADMAS7Write()
{
    ...
    spuaddr = C1_SPUADDR;
    // SPU2 Deinterleaves the Left and Right Channels
    memcpy((short*)(spu2mem + spuaddr + 0x2000),(short*)Adma7.MemAddr,512);
    Adma7.MemAddr += 256;
    memcpy((short*)(spu2mem + spuaddr + 0x2200),(short*)Adma7.MemAddr,512);
    Adma7.MemAddr += 256;
    spuaddr = (spuaddr + 256) & 511;
    C1_SPUADDR_SET(spuaddr);
...
#endif
    if((spu2Ru16(REG_C1_ADMAS) & 0x1) && (spu2Ru16(REG_C1_CTRL) & 0x30) == 0 && size)
    {
        //fwrite(pMem,iSize<<1,1,LogFile);
...
u16  CALLBACK SPU2read(u32 mem)
{
    ...
    if((r>0x01c0 && r<=0x02E0)||(r>0x05c0 && r<=0x06E0))  // some channel info?
    {
        ...
        switch(rx) {
            case 0x1C0: return (((pvoice->pStart-(u8*)spu2mem)>>17)&0x3F);
            case 0x1C2: return (((pvoice->pStart-(u8*)spu2mem)>>1)&0xFFFF);
            case 0x1C4: return (((pvoice->pLoop-(u8*)spu2mem)>>17)&0x3F);
            case 0x1C6: return (((pvoice->pLoop-(u8*)spu2mem)>>1)&0xFFFF);
            case 0x1C8: return (((pvoice->pCurr-(u8*)spu2mem)>>17)&0x3F);
            case 0x1CA: return (((pvoice->pCurr-(u8*)spu2mem)>>1)&0xFFFF);
        }
    }
