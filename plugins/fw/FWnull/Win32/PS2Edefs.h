...
#define PS2E_SPU2_VERSION 0x0002
#define PS2E_CDVD_VERSION 0x0003
#define PS2E_DEV9_VERSION 0x0002
#define PS2E_USB_VERSION  0x0001
#define PS2E_FIREWIRE_VERSION 0x0001
#ifdef COMMONdefs
...
void CALLBACK USBirqCallback(void (*callback)());
...
typedef void (CALLBACK* _USBirqCallback)(void (*callback)());
